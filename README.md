...
you'll need to have a database installed on your system. Nemesis uses postgres, other databases are not supported. 
This is how you would set up a the database on a debian/ubuntu system. Other distributions may vary.
